---
name: "task-easy"
description: "Easy tier of the generic task worker, selected automatically by omp-jev-router. Do not request it directly; dispatch `task` and let the router pick the tier."
spawns: "*"
model: "@task_easy"
thinking-level: "auto"
---
