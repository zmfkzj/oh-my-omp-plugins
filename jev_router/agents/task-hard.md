---
name: "task-hard"
description: "Hard tier of the generic task worker, selected automatically by omp-jev-router. Do not request it directly; dispatch `task` and let the router pick the tier."
spawns: "*"
model: "@task_hard"
thinking-level: "auto"
---
